...
var strings = 
	...
	"**/",
	"&nbsp;return this.CreateContractileVacuole.vacuole.out(\"Hello World!\");",
	"}",
...
var state = {
	...
	logo_parsed: false,
	logo_clicks: 0,
	logo_rest: ["/** This object implements an object that shall generate MOAR objects. **/", 
	...
	logo_special: ["/** CONGRADULATION! You have clicked me 10 times! **/", 
					...
					"/** YOU can stop clicking me, I will implicitly congratulate you every time henceforth. **/"],
	menu:{
		cv: false,
		pj: false,
		lk: false,
